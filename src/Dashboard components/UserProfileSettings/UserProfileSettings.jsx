...
const UserProfileSettings = () => {
  ...
  const { isPending, isError, error, data: userData, refetch } = useQuery({
    queryKey: ["data", "user"],
    queryFn: async () => {
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="max-w-lg mx-auto">
              ...
              <div className="mx-auto w-32 h-32 border rounded-full relative bg-gray-100 mb-4 shadow-inset">
                <img id="image" className="object-cover w-full h-32 rounded-full" src={user.photoURL} alt="Profile" />
              </div>
